...
* Milestone 1: **Initial proposal**. This should include:
...
* Milestone 2: **Dataset, exploratory visualization, and summary of prior work**
...
#| output: asis
print("`````python")
print(open('final-proj-template.qmd').read())
print(("`````"))
