...
your instructor happened to fit (while playing around with decision trees
for the last section); notice what's different when you apply these
techniques to different models.

First, let's get a model fit on the whole training set. (Remember, the cross
validation process trained a bunch of smaller models; now we want to look
at the slightly bigger full model.)
