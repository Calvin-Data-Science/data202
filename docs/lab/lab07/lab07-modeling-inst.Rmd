...
* Finish the sentence: "On average, this model's predictions were off by about $___ on the sales it saw during training".

Preview for later: can we do better? Think about the following:

* What information about a house did this model use to make its prediction?
* What mathematical operations could it do with kinds of computations could it do to that data?
...
Finish the sentence: "On average, this model's predictions were off by about $___ on homes it hadn't seen before".
