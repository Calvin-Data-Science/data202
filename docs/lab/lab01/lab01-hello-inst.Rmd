...
Note that you can access RStudio anywhere using these steps.
...
If you're done with your lab, use the remaining time to take the Intro survey on Moodle. If time is up for the lab session, complete the survey at home by Monday.
