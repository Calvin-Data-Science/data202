...
Click [here](https://classroom.github.com/g/3LZemoVC) to claim your repo and get the URL to clone.

Refer to Lab 01 if you would like to see step-by-step instructions for cloning a repo into an RStudio project.

First, open the R Markdown document `lab02-plastic-waste.Rmd` and Knit it. Make sure it compiles without errors. The output will be in the file markdown `.md` file with the same name.

## The data

The dataset for this assignment can be found as a csv file in the `data` folder of your repository.
The assignment template includes commands to load the necessary packages and read the data, so
*Run All in the RMarkdown document*.
...
Find this dataset in the Environment pane and look at some examples.
...
1. *Optional!* Recreate the following plot, and interpret what you see in context of the data.
