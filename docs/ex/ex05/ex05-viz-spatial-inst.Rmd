...
fs::file_copy("data/states.csv", here::here("src/ex/ex05-viz-spatial/data/states.csv"))
```
...
7.  Find the La Quinta locations that are outside the US, and figure out which country they are in.
    One way to do this is by finding their lat/long on Google Maps: for the first one, you could search `21.755585,-102.27633` (you don't need many decimal places).
