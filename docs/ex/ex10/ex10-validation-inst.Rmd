...
Here's a utility function to show a model's predictions:
...
The following code fragment collects the residuals for all 3 models on `ames_train` and `ames_test`.
