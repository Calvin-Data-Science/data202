...
* You may make slides if you like (using Xaringan, ioslides, PowerPoint, etc.), Shiny apps, etc., but please also submit a report document in HTML format (PDF is also allowed if you have a good reason to).
