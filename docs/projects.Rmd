...
* Overview
  * Introduce the article you've found and the specific visualization you're replicating, including:
...
* Replication
  ...
  * Briefly describe any difficulties you encountered, both those you
    overcame and those you still have not. (It's ok to not have a perfect graph.)
* Alternative Designs
  ...
  * Attempt to implement your best alternative design.
* Summary
