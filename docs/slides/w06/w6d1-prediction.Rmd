...
* **Precision Agriculture**: predict effect of microclimate on plant growth
...
* **User interfaces**: gesture typing, 
...
* God created the world with actionable structure
  * We act rightly when our perceptions align with that structure
