...
That means everything is already configured. (*Note*: there's currently a problem
with Python chunks on the RStudio server. Until we resolve it, please use <https://remote.cs.calvin.edu>
or install RStudio on your own machine.)
...
Clone your repo as usual. Knit and make sure that the Python code block runs.
