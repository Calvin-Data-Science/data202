...
First, open the R Markdown document `hw01/hw01-warmup.Rmd` and Knit it. Make sure it compiles without errors. The output will be in the `.html` file with the same name.

Then, change the title to "Homework 1: Warmup" and the author name to your name.
