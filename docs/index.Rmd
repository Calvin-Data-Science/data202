...
* **Office Hours**: **Poll will be taken to determine best times**. Then: see [my Google Calendar](https://kenarnold.org/calendar.html), or by appointment
* Teaching Assistant / Grader: Yejae Kim

# Pandemic-Related Policies

In this time we expect you to take responsibility for both your own health and also your peers’ health. If you are feeling at all “under the weather” (even if it’s just from not getting enough sleep) or have any reason to suspect that you might have been exposed to Covid or another communicable disease, please feel free to stay home and join our class remotely, no questions asked.
 
Your instructor will be following the same policy. I will let you know by Teams before each class day if that day will be held online. I hope to give as much notice as possible, but this decision may need to be made at the last minute.
