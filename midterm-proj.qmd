...
To fix it, the person who **can** read the file should run the following code chunk. After the code chunk runs successfully, you should remove it from your report.
