...
number of bookings in the resort hotel (coded as `Resort Hotel`) that have more than 1 child **or** baby 
in the room.
...
Then, do the same for the city hotel (coded das `City Hotel`), and compare the numbers of 
...
Create a frequency table of the number of `adults` in a booking. (Use `count`.) Display the 
