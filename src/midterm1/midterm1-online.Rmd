...
**How many rows in `car_prices` didn't match the EPA data?**
...
**Reproduce the following plot** using the `car_prices_and_eco` data frame. *Note*: you will need to reshape the data.
