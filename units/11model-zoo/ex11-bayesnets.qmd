...
Our dataset consists ofcategorical variables, and we haven't seen exactly how to use them as features with the sklearn library.
...
*Indicate which model you are using*. Suggestions are linear regression, decision trees or random forests.
...
We will now check how better a Bayesian network model will perform.
