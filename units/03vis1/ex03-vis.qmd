...
For example, you should make your own `qmd` file, following the [Class Standards](../../notes/quarto.qmd#class-standards) (especially regarding the YAML header). You may use past exercises as inspiration, but avoid copy and paste.
