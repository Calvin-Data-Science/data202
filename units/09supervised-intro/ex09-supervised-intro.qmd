...
In English: What's the target variable? What are the features? What metrics will we use to evaluate the model? How will we evaluate the model on unseen data?
