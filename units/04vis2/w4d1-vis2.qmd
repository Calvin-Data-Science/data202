...
```{python}
px.histogram(loans, x="loan_amount", nbins=10)
```
...
```{python}
px.histogram(loans, x="loan_amount", nbins=100)
```
...
```{python}
px.histogram(loans, x="loan_amount", nbins=30, color="homeownership",  barmode="stack")
```
:::
:::
