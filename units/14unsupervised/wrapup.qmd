...
- More general approach: [time series cross-validation](https://scikit-learn.org/stable/modules/generated/sklearn.model_selection.TimeSeriesSplit.html)
...
Read more: [When is automated decision making legitimate?](https://fairmlbook.org/legitimacy.html)
