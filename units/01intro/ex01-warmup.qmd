...
2. If you haven't already done so, create a new project for your class exercises; call it `data202-exercises` and place it in the `rprojects` folder.
3. Create a new Quarto document called `ex01.qmd` in the `hw` folder of your project.
