...
3. Can you try out some of the other options for `px.scatter`? See the plotly reference materials linked to from the [notes](https://calvin-data-science.github.io/data202/notes/tools.html)
