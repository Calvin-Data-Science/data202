...
3. Create a new Quarto document called `ex01.qmd` in the `ex` folder of your project.
...
5. Expand the block below, click the Copy button in the top-right, then paste the copied text into your new document.
...
::: {.callout-tip collapse="true" title="How to export your document from the Posit server"}
...
1. Can you use *code* to get the number of rows, instead of typing it out? See "[Putting computed results in the document](https://calvin-data-science.github.io/data202/notes/quarto-recipes.html)" in the notes.
2. Can you try out some of the other options for `px.scatter`? See the plotly reference materials linked to from the [notes](https://calvin-data-science.github.io/data202/notes/tools.html)
3. Can you reproduce the Gapminder "health and wealth" plot from the video?
