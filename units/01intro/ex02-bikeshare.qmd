...
This time, try to use a code chunk to compute the answer. (See the [class notes on Quarto](../../notes/quarto.qmd) for how to do this.)
...
-   Make the points smaller (`marker_size` of 3) and partially transparent (`marker_opacity` of 0.5) to reduce *overplotting*.
...
Make sure that your `qmd` file renders successfully by clicking Render. Spot-check that your most recent change is reflected in the rendered output. Then, submit your `html` file to Moodle. Here's how:
