...
This time, try to use a code chunk to compute the answer. (See the class notes for how to do this.)
...
![hw2 Date vs. Rides](images/hw2_bikeshare_date-rides.png)
...
1. Make a scatterplot like in Exercise 3, but map `shape` to `workingday`.
...
Here's one possible plot; try to make it.<br>
![hw2 day vs rides](images/hw2_bikeshare_day-rides.png)
