...
This time, try to use a code chunk to compute the row counts. (See the [class notes on Quarto](../../notes/quarto.qmd#computations-in-text) for how to do this.)


- [ ] Does my answer use a code chunk to compute the row count?
- [ ] Does my answer include the number of rows?
- [ ] Does my answer describe what each row represents?
- [ ] When I render my document, do I see the correct number of rows?
- [ ] When I render my document, does the result show up like code or like text?
...
- [ ] Did I describe the mapping in prose?
- [ ] Did I include evidence that the mapping is correct?
- [ ] Did I fill in the blank in the code block?
- [ ] Did I check that the result is correct?
