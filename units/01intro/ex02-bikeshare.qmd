...
Run the data-loading chunk in the Quarto document. In the Environment pane, click the `daily_rides` dataframe to open a view of the data.
...
Describe, in one  or two English sentences, the information conveyed by the first row in the data frame. Focus your description on only following fields: `date`; `rider_type`; `rides`; `holiday`; `workingday`; and `day_of_week`.
