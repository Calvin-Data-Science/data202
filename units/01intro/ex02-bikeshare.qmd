...
-   Make the points smaller (`marker_size` of 3) and partially transparent (`marker_opacity` of 0.5) to reduce *overplotting*. The `update_traces` function in the template can be used for this; we will discuss this more fully in the next week or two.
