...
3. Create a new Quarto document called `hw01.qmd` in the `hw` folder of your project.
...
::: {.callout-note collapse="true" title="Template for hw01.qmd"}

```{python}
#| echo: false
#| output: asis
print("`````python")
print(open('hw01-warmup-template.qmd').read())
print(("`````"))
