---
title: "Exercise 6: Pivoting and Joining - Added Notes"
execute: 
  echo: false
---
...
Create a folder and a Quarto file, as usual. You can use `ex06-pivot-join.qmd`. The usual setup code can be found in thou [course notes](../../notes/quarto.qmd#class-standards).
...
gapminder_with_regions = (
    ...
    [["country", "region"]]
    .merge(gapminder, on="country", how="outer", indicator=True)
)
```
...
#| include: false
#| eval: false
gapminder_with_regions['gdp_rank'] = (
    gapminder_with_regions
    .groupby('year', as_index=False)
    ['gdp_pcap']
    .rank(ascending=False)
)
gapminder_with_regions.query('year == 2007 and gdp_rank < 20').sort_values('gdp_rank')
```
...
px.scatter(
    ...
    hover_name="country",
    labels={"gdpPercap": "GDP per capita", "lifeExp": "Life expectancy (at birth)", "region": "region", "year": "Year"},
