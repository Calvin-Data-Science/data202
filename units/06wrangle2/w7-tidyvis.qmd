...
- Reading: [Part 2 of Wilke](https://clauswilke.com/dataviz/proportional-ink.html) (ch 17-26) has a lot of useful stuff; also read "[29 Telling a story and making a point](https://clauswilke.com/dataviz/telling-a-story.html)"
...
## Write the reshaping code {.smaller}
...
px.histogram(
    staff_long,
    x="percentage", y="year", color="faculty_type",
)
```
...
px.line(
    staff_long,
    y="percentage", x="year", color="faculty_type",
)
```
