...
- Under "Choose individual indicators" select "GDP per capita (price and inflation adjusted, in PPP$2017)"
- At the top of the table, click Download As: CSV or XLSX. I got a file named `lex.xlsx`
- Click the header ("GDP per capita") and select "Life Expectancy, at birth". Download that as well. I got a file named `gdp_pcap.xlsx`
...
Now you can make the plot. By now you should be able to do this without further guidance. Note that we don't have continent data, so you can't color by continent. But you can use `animation_frame` to animate the plot by year.
